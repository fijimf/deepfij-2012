...
alter table permission drop foreign key FKE125C5CF4F4A20E0;
...
create table game (id bigint not null auto_increment, date datetime not null, isConferenceTournament bit not null, isNcaaTournament bit not null, isNeutralSite bit not null, updatedAt datetime, awayTeamId bigint, homeTeamId bigint, schedule_id bigint, primary key (id));
create table metaStat (id bigint not null auto_increment, higherIsBetter bit, keyName varchar(255) unique, name varchar(255) unique, primary key (id));
create table permission (id bigint not null auto_increment, permission varchar(255) not null, updatedAt datetime not null, role_id bigint, primary key (id));
...
create table role (id bigint not null auto_increment, name varchar(255) not null, updatedAt datetime not null, primary key (id));
...
alter table permission add index FKE125C5CF4F4A20E0 (role_id), add constraint FKE125C5CF4F4A20E0 foreign key (role_id) references role (id);
