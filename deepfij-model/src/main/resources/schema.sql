...
create table metaStat (id bigint not null auto_increment, format varchar(255), higherIsBetter bit, name varchar(255) unique, keyName varchar(255) unique, primary key (id));
